...
public class Application extends JFrame {
	...
	public Application() {
		...
		JLabel lblPersonnelMgmt = new JLabel("Quản lí hướng dẫn viên");
		...
		JLabel lblFinanceMgmt = new JLabel("Quản lí tài chính");
		...
		JLabel lblVehicleMgmt = new JLabel("Quản lí khách hàng");

 ...
 * @author Thin
 */
public class CTKeHoachTourGUI extends javax.swing.JFrame {

    /**
     * Creates new form CTKeHoachTourGUI
     */
    public CTKeHoachTourGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lstDSSK.setBackground(new java.awt.Color(255, 255, 255));
        lstDSSK.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 102), 3, true));
        ...
        lstDSSK.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
                lstDSSKValueChanged(evt);
            }
        });
        jScrollPane1.setViewportView(lstDSSK);
    ...
    private void lstDSSKValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_lstDSSKValueChanged
        // TODO add your handling code here:
        int selectedIndex = lstDSSK.getSelectedIndex();
        ...
        */
        ...
        if(selectedIndex == 4){
            DiaDiemThamQuanGUI ddtqGUI = new DiaDiemThamQuanGUI();
    ...
    }//GEN-LAST:event_lstDSSKValueChanged
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CTKeHoachTourGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CTKeHoachTourGUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JList<String> lstDSSK;
